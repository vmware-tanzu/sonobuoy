...
// processRaw will return an Item object with the File value set to the path in question. If the
// file is unable to be stat'd then the status of the Item is StatusFailed (StatusPassed otherwise).
func processRawFile(pluginDir, currentFile string) (Item, error) {
