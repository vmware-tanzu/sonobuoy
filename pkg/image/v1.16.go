...
// NOTE: This is manually replicated from: https://github.com/kubernetes/kubernetes/blob/v1.16.0/test/utils/image/manifest.go#L205-L253
...
func (r *RegistryList) v1_16() map[string]Config {
	...
	// The following registry variable has the same value as the e2eRegistry but
	// has been left here to match with the code taken from upstream.
	// See the definition here: https://github.com/kubernetes/kubernetes/blob/v1.16.0/test/utils/image/manifest.go#L98
	e2eGcRegistry := r.E2eRegistry
